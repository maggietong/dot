...
c.ScriptMagics.script_magics.append('python2.7')
c.InteractiveShellEmbed.colors = 'Linux'
c.InteractiveShellEmbed.deep_reload = True
#c.InteractiveShellEmbed.history_length = sys.maxint
c.InteractiveShellEmbed.history_length = 99999999
c.InteractiveShellEmbed.automagic = False
c.InteractiveShellEmbed.xmode = 'Plain'
c.IPCompleter.greedy = True
#c.IPCompleter.limit_to__all__ = False
#c.IPCompleter.omit__names = 2
#c.IPCompleter.merge_completions = True
c.InteractiveShellEmbed.debug = GLOBAL_DEBUG
...
c.InteractiveShell.editor = '/usr/local/bin/gvim'
c.InteractiveShell.colors = 'Linux'
c.InteractiveShell.banner = u''
c.InteractiveShell.banner1 = u''
c.InteractiveShell.banner2 = u''
c.InteractiveShellEmbed.banner = u''
c.InteractiveShellEmbed.banner1 = u''
c.InteractiveShellEmbed.banner2 = u''
c.ZMQInteractiveShell.editor = '/usr/local/bin/gvim'
...
c.IPythonWidget.editor = '/usr/local/bin/gvim'
#c.ZMQInteractiveShell.logappend = 'appendmode.log'
messages = os.path.join(LOG_DIR, 'messages-{0}.log'.format(os.getpid()))

c.InteractiveShellEmbed.logfile = messages
c.InteractiveShellEmbed.logstart = True
c.InteractiveShellEmbed.pdb =  False
c.InteractiveShellEmbed.pydb = True

c.ZMQInteractiveShell.logfile = messages
c.ZMQInteractiveShell.logstart = True
c.ZMQInteractiveShell.pdb = False
c.ZMQInteractiveShell.pydb = True
